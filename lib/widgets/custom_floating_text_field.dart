...
extension FloatingTextFormFieldStyleHelper on CustomFloatingTextField {
  static OutlineInputBorder get outlineGray60003 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            4.00,
          ),
  ...
  static OutlineInputBorder get outlineGray60003TL4 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            4.00,
          ),
        ...
        borderSide: BorderSide(
          color: appTheme.gray60003.withOpacity(0.12),
          width: 1,
        ),
      );
}
